...
class Incidents extends React.Component {
    ...
    getPageData = () => {
        this.setState({
            pageData: this.state.incidents.slice(this.state.offset, this.state.offset + INCIDENTS_ON_PAGE),
            pageCount: Math.ceil(this.state.incidents.length / INCIDENTS_ON_PAGE)
        });
    }
