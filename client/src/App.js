                    ...
                    <div className="app">
                        ...
                        <main>
                            <Switch>
                                ...
                                <Route exact path="/licenses" component={RequireAuth((props) => <Licenses {...props} store={user} />, user)} />
                                <Route exact path="/bolo" component={RequireAuth((props) => <Bolo {...props} boloCitizens={this.state.boloCitizens} boloVehicles={this.state.boloVehicles} store={user} />, user)} />
                                ...
                                <Route exact path="/inventory" component={RequireAuth(() => <Inventory store={user} />, user)} />
